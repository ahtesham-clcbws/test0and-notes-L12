        ...
        <div class="card-body">
            <form method="POST" action="" id="loginForm">
                ...
                @else
                    ...
                    <a href="{{ route('administrator.login') }}?password_reset">Reset password again?</a><br>
                    <a href="{{ route('administrator.login') }}">Back to login</a></p>
                @endif
                @if ($data['success'])
