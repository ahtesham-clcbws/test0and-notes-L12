                    ...
                    <ul class="navbar-nav dashboard2 second_row_nav">
                        <li class="">
                            <button class="panel-heading">
                                <img src="{{ asset('student/images/watch.png') }}" class="watch_ic">
                            </button>
                            <div class="dropdown-content panel-collapse noti_box">
                                ...
                                <ul>
                                    <li>
                                        <a href="#">
                                            <img src="{{ asset('student/images/watch.png') }}" class="noti_icon">
            ...
            <div class="row">
                <div class="col-md-2 card-1">
                    <div class="card">
                        <div class="part1">
                            <div class="img_area">
                                <img class="box_icon" src="{{ asset('student/images/1.png') }}">
                            </div>
                            <div class="head_area">
                ...
                <div class="col-md-2 card-2">
                    <div class="card">
                        <div class="part1">
                            <div class="img_area">
                                <img class="box_icon" src="{{ asset('student/images/2.png') }}">
                            </div>
                            <div class="head_area">
                                <div class="number">3</div>
                ...
                <div class="col-md-2 card-3">
                    <div class="card">
                        <div class="part1">
                            <div class="img_area">
                                <img class="box_icon" src="{{ asset('student/images/3.png') }}">
                            </div>
                            <div class="head_area">
                                <div class="number">3</div>
                ...
                <div class="col-md-2 card-4">
                    <div class="card">
                        <div class="part1 new_col">
                            <div class="img_area">
                                <img class="box_icon" src="{{ asset('student/images/4.png') }}">
                            </div>
                            <div class="head_area">
                                <div class="number">3</div>
                ...
                <div class="col-md-2 card-5">
                    <div class="card">
                        <div class="part1 new_col">
                            <div class="img_area">
                                <img class="box_icon" src="{{ asset('student/images/5.png') }}">
                            </div>
                            <div class="head_area">
                                <div class="number">3</div>
                ...
                <div class="col-md-2 card-6">
                    <div class="card">
                        <div class="part1 new_col">
                            <div class="img_area">
                                <img class="box_icon" src="{{ asset('student/images/6.png') }}">
                            </div>
                            <div class="head_area">
                                <div class="number">3</div>
