...
@section('main')
    <input class="d-none" id="franchiseId" value="{{ $data['id'] }}">
            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    <div class="card-header" style="background-color:#19467a ; color: white;">
                        ...
                        <div>
                            <h5>Created on {{ date('d M Y', strtotime($data['created_at'])) }}</h5>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="col-md-12">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td rowspan="2" class="userImageCell">
                                                <img id="profile_img"
                                                    src="{{ $data['details']['photo_url'] ? '/storage/app/public/'.$data['details']['photo_url'] : asset('noimg.png') }}"
                                        ...
                                        <tr>
                                            ...
                                            <td class="information-txt">{{ $data['mobile'] }}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2"><b>Email</b></td>
                                            <td class="information-txt" colspan="2">{{ $data['email'] }}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="information-txt" colspan="2">{{ $data['institute_name'] }}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2"><b>Institute Type</b></td>
                                            <td class="information-txt" colspan="2">

                                                @foreach (json_decode($data['type_of_institution']) as $type)
                                                    <span class="commaList">{{ $type }}</span>
                                                @endforeach
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="information-txt" colspan="2">
                                                ...
                                                @foreach (json_decode($data['interested_for']) as $for)
                                                    <span class="commaList">{{ $for }}</span>
                                                @endforeach
                                            </td>
                                        </tr>
                                        <tr>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mid-content">
                            <textarea id="approved-message" name="type" id="" cols="30"
                                rows="10">Please use this ({{ $data['branch_code'] }}) branch code, to signup so we can go further on your request.</textarea>
                        </div>
                        <div class="control-area">
                            <button class="btn btn-danger" onclick="closeBox()">Close</button>
                                    ...
                                    <div class="dropdown" data-control="checkbox-dropdown">
                                        ...
                                        <div class="dropdown-list">
                                            ...
                                            {{-- <label for="" class="dropdown-option">
                                                <input type="checkbox" value="Selection 0" />
...
@section('javascript')
    ...
    <script>
        ...
        $('#reply-hidden').submit(function(event) {
            ...
            formData.append('form_name', 'set_franchise');
            var franchise_type_checked = $('.franchise_type:checked').length;
            var franchiseTypeDiv = $('#franchiseTypeDiv');
            if (franchise_type_checked == 0) {
                $(franchiseTypeDiv).css('border', '2px solid crimson');
                showToast('Please select atleast one franchise type', 'bg-danger');
                setTimeout(() => {
                    franchiseTypeDiv.css('border', 'none');
                }, 3000);
                return;
            }
            ...
            $.ajax({
                ...
                // location.reload();
                window.location = "{{ route('administrator.dashboard') }}";
            }).fail(function(data) {
