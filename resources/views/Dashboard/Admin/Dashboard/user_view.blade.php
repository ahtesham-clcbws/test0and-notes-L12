            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    <div class="card-header" style="background-color:#19467a ; color: white;">
                        ...
                        <div>
                            <h5>{{ $data['remainingSubscription'] }}</h5>
                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="studentTable">
                                    <tbody>
                                        <tr>
                                            <td class="userImageCell" colspan="2">
                                                <img id="profile_img"
                                                    src="{{ isset($data['details']) && $data['details']['photo_url'] ? '/storage/' . $data['details']['photo_url'] : asset('noimg.png') }}"
                                                    style="width:80px;height:80px;border:1px solid #c2c2c2;  ">

                                            </td>
                                            <td><button type="button" style="margin-top: 5px; float:right;" class="btn btn-success" onclick="printTable()">Print Form</button></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="information-txt" colspan="2">{{ $data['user']['mobile'] }}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="information-txt" colspan="2">{{ $data['education_type_name']->name ?? '' }}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2"><b>Class</b></td>
                                            <td class="information-txt" colspan="2">{{ $data['class_name']->name ?? '' }}</td>
                                        </tr>

                                        @if ($data['user']['in_franchise'])
                                            <tr>
                                                <td colspan="2"><b>Institute Name</b></td>
                                                <td class="information-txt" colspan="2">
                                                    {{ $data['user']->myInstitute['institute_name'] }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2"><b>Institute Code</b></td>
                                                <td class="information-txt" colspan="2">
                                                    {{ $data['user']->myInstitute['branch_code'] }}
                                                </td>
                                            </tr>
                                        @endif
            ...
            <div class="col-md-6 col-12">
                ...
                <div class="card" id="approved-show">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mid-content">
                            <textarea id="approved-message" name="type" id="" cols="30" rows="10"></textarea>
                        </div>
                        <div class="control-area">
                            <button class="btn btn-danger" onclick="closeBox()">Close</button>
                ...
                <form class="card" id="reply-hidden">
                    ...
                    @if($data['user']['is_staff'] == 0)
                        <h5>Student Activation Form</h5>
                    @else
                        <h5>Contributor Activation Form</h5>
                    @endif
                    </div>
                    <div class="card-body">
                                            ...
                                            <div class="dropdown-list">
                                                ...
                                                <label class="dropdown-option">
                                                    <input type="checkbox" class="franchise_role" name="role[]"
                                                        value="manager" {{ $data['manager'] ? 'checked' : '' }} />
                                                    Manager
                                                </label>

                                                <label class="dropdown-option">
                                                    <input type="checkbox" class="franchise_role" name="role[]"
                                                        value="creator" {{ $data['creator'] ? 'checked' : '' }} />
                                                    Creator
                                                </label>
                                                ...
                                                {{--<label class="dropdown-option">
                                                    <input type="checkbox" class="franchise_role" name="role[]"
                                                        value="verifier" {{ $data['verifier'] ? 'checked' : '' }} />
                                                    Verifier
                                                </label>

                                                <label class="dropdown-option">
                                                    <input type="checkbox" class="franchise_role" name="role[]"
                                                        value="reviewer" {{ $data['reviewer'] ? 'checked' : '' }} />
                                                    Reviewer
                                                </label>--}}
                                            </div>
                                        </div>
                            ...
                            <div class="box-input">
                                <div class="input-group">
                                    ...
                                    <select class="form-select" id="inputGroupSelect01" name="days"
                                        data-style="btn-new">
                                        <option {{ $data['selectedDays'] == 0 ? 'selected' : '' }} value="0">No
                                            subscription
                                        </option>
                        ...
                        <input type="hidden" name="is_staff" value="{{ $data['user']->is_staff }}">
                        <div class="d-flex mb-2">
                            ...
                            <div class="box-input">
                                ...
                                <div class="input-group flex-nowrap">
                                    ...
                                    <input type="text" name="mobile" class="form-control"
                                        value="{{ $data['user']->mobile }}" placeholder="Person name">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control" id="education_type_id" name="education_type_id" onchange="getClassesByEducation(this.value)" required>
                                                    ...
                                                    @foreach($data['gn_EduTypes'] as $u)
                                                        <option value="{{ $u->id }}" <?php if($data['education_type'] == $u->id){echo 'selected';} ?>>{{ $u->name}}</option>
                                                    @endforeach
                                                </select>
                                </div>
                            </div>
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <div class="box-input">
                                <!-- <div class="box-icon"></div> -->
                                <div class="input-group">
                                    <label class="input-group-text" for="inputGroupSelect03"><i class="fa fa-users" aria-hidden="true"></i></label>
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <div class="box-input">
                                ...
                                <div class="input-group flex-nowrap">
                                    ...
                                    <span class="input-group-text togglePassword" id="addon-wrapping">
                            ...
                            <div class="box-input">
                                ...
                                <div class="input-group flex-nowrap">
                                    ...
                                    <input type="text" name="institute_name" class="form-control"
                                        value="{{ $data['institute_name']->institute_name ?? '' }}" placeholder="Person name">
                                </div>
                            </div>
                        </div>
                        <div class="d-flex mb-2">
                            ...
                            <div class="box-input">
                                ...
                                <div class="input-group flex-nowrap">
                                    <span class="input-group-text" id="addon-wrapping"><i
                                            class="bi bi-list"></i></span>
                                    <input type="text" name="institute_code" class="form-control"
                                        value="{{ $data['institute_code']?->institute_code }}" placeholder="Person name">
                                </div>
                            </div>
                        </div>
                        <div class="d-flex mb-2">
                            ...
                            <div class="box-input">
                                ...
                                <div class="input-group flex-nowrap">
                                    ...
                                    <input type="text" name="created_at" class="form-control"
                                        value="{{ date('d M Y', strtotime($data['user']['created_at'])) }}" placeholder="Person name" readonly>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="box-input">
                                ...
                                <div class="input-group flex-nowrap">
                                    <span class="input-group-text" id="addon-wrapping"><i
                                            class="bi bi-list"></i></span>
                                    <input type="text" name="created_at" class="form-control"
                                        value="{{ $data['renewal_date'] }}" readonly>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="box-input">
                                ...
                                <div class="input-group flex-nowrap">
                                    <span class="input-group-text" id="addon-wrapping"><i
                                            class="bi bi-list"></i></span>
                                    <input type="text" name="created_at" class="form-control"
                                        value="{{ $data['remainingSubscription'] }}" placeholder="Remaining Subscription" readonly>
                                </div>
                            </div>
                        </div>
...
@section('javascript')
    ...
    <script>
        ...
        */
        ...
        var student_class = <?php if(isset($data['class'])){ echo $data['class']; }else{ echo 0;}  ?>;
        ...
        if (data && data.success) {
            ...
            if (classes.length > 0) {
                ...
                $(classes).each(function (index, item) {
                    ...
                    if(student_class == item.id){
                        class_select = 'selected';
                    }else{
                        class_select = '';
                    }
                    options += '<option value="' + item.id + '" '+class_select+'>' + item.name + '</option>';
                });
