...
@section('main')
    <div class="container p-0">
        <form class="card dashboard-container mb-5" method="post" id="testForm" enctype="multipart/form-data">
            @error('testError')
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-4">
                            ...
                            <input type="file" id="test_image" name="test_image" class="form-control form-control-sm">
                    </div>
                    @if(isset($data['test']))
					<div class="col-4">
                    ...
                    <div class="col-6">
                           ...
                           <input type="text" class="form-control form-control-sm" id="sub_title" name="sub_title"
                                value="{{ $data['test'] ? $data['test']['sub_title'] : '' }}" placeholder="Test Subtitle">
                    </div>
                </div>
                {{-- part 3 --}}
                <div class="row mt-3">
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                            ...
                            {{-- remove getPackage(this.value) from onchange event --}}
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="" id="time_to_complete_div">
                ...
                <div class="row ">
                    ...
                    {{-- <div class="col-3">
                        ...
                        <div id="divinfo3" style="margin-bottom:20px;">
                            <select class="form-select form-select-sm" id="test_type" name="test_type" onchange="getPackage(this.value)" required>
                                <option value="">Select</option>
                                <option @if($data['test']->test_type == "1") selected @endif value="1">Free</option>
                                <option @if($data['test']->test_type == "0") selected @endif value="0">Paid</option>
                                <option onclick="test()" @if($data['test']->test_type == "2") selected @endif value="2">Free without Package</option>
                                <option @if($data['test']->test_type == "3") selected @endif value="2">Paid without Package</option>
                            </select>
                        </div>
                    </div> --}}
      <!--              <div class="col-3">-->
						<!--<div class="form-group">-->
						<!--	<label for="Document Upload Type" class="control-label">Study Material Package Category</label>-->
							<!--//onchange="getpackage(this)"-->
						...
						<!--		<option value="1" <?php if(isset($data['test']) && isset($data['test']->test_type) && $data['test']->test_type == '1') { echo 'selected'; }?>>Free Package</option>-->
						<!--		<option value="0" <?php if(isset($data['test']) && isset($data['test']->test_type) && $data['test']->test_type == '0') { echo 'selected'; }?>>Paid Package</option>-->
						<!--		<option value="2" <?php if(isset($data['test']) && isset($data['test']->test_type) && $data['test']->test_type == '2') { echo 'selected'; }?>>Free Without Package</option>-->
						<!--		<option value="3" <?php if(isset($data['test']) && isset($data['test']->test_type) && $data['test']->test_type == '3') { echo 'selected'; }?>>Paid Without Package</option>-->
								<!--<option value="uncategrized">Uncategrized</option>-->
						<!--	</select>-->
						<!--</div>-->
      <!--              </div>-->
                    ...
                    <!--            value="{{ $data['test']->price}}" placeholder="Enter Test">-->
                    <!--    </div>-->
                    <!--</div>-->
                    {{-- <div class="col-3" id="packages">
                        <div class="">
                            <small><b>Add Package</b></small>
                        </div>
                        <div id="package_html" style="margin-bottom:20px;">
                    ...
                    <div class="col-3">
                        ...
                        <div id="divinfo3" style="margin-bottom:20px;">
                            <select class="form-select form-select-sm select2" id="test_cat" name="test_cat" >
                                <option value="">Select Category</option>   
                                @foreach($data['test_cat'] as $list)
                    ...
                    <div class="col-3">
                        ...
                        <div id="divinfo3" style="margin-bottom:20px;">
                            <input type="text" class="form-control form-control-sm" id="special_remark_1" name="special_remark_1"
                                value="{{ $data['test'] ? $data['test']['special_remark_1'] : '' }}" placeholder="Special Remark 1">
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="">
                        ...
                        <div id="divinfo3" style="margin-bottom:20px;">
                            <input type="text" class="form-control form-control-sm" id="special_remark_2" name="special_remark_2"
                                value="{{ $data['test'] ? $data['test']['special_remark_2'] : '' }}" placeholder="Special Remark 2">
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="">
                        ...
                        <div id="divinfo3" style="margin-bottom:20px;">
                            <input type="number" step="0.1" class="form-control form-control-sm" id="rating" name="rating"
                                value="{{ $data['test'] ? $data['test']['rating'] : '4.5' }}" placeholder="Rating">
                        </div>
                    </div>
                </div>
                {{-- part 4 --}}
                <div class="row mt-3">
                    ...
                    <!-- <div class="col-md-12 col-sm-6 col-12">
                        <div class=" {{ ($data['test'] && $data['test']['time_to_complete'] > '0' ? ' noDisplay ' : '') ? ' noDisplay ' : '' }}"
                        ...
                        <form class="card-body" method="post" id="sections_form">
                            ...
                            @if (count($data['sections']))
                                @foreach ($data['sections'] as $key => $section)
                                    <div class=" text-dark test_sections_div"
                                            ...
                                            <div class="col-md-6 text-end">
                                                <div class="btn-group mb-2" role="group" aria-label="Basic outlined example">
                                                    ...
                                                    <button type="button" class="btn btn-outline-primary" style="padding: 5px;">
                                                        @if($data['test']->negative_marks == 0){{ 'No Negative Marking' }} @else {{ '-' }} {{ $data['test']->negative_marks }}{{ '%' }} @endif
                                                    </button>
                                                    <button type="button" class="btn btn-outline-primary">
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-md-3 col-sm-6 col-12">
                                                ...
                                                <select class="form-select form-select-sm section_questions"
                                                    ...
                                                    <option value="" disabled>Choose questions</option>
                                                </select>
                                            </div>
                                            <!-- <div class="col-md-3 col-sm-6 col-12">
                                ...
                                @endforeach
                            @else
                                <div class=" mt-4" id="noSectionAlert">
                                    <div class="row">
                            ...
                            @endif
                            <button class="btn btn-success {{ count($data['sections']) ? '' : 'noDisplay' }}" id="saveSectionButton">Submit Request</button>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <script id="sectionTemplate" type="text/html">
        <div class=" text-dark test_sections_div" id="test_sections_{0}">
