                                    ...
                                    <tbody>
                                        @foreach ($data['questions'] as $key => $question)
                                            <tr>
                                                ...
                                                <td scope="col" class="test-que-img">{!! $question->question->question !!}</td>
                                                <td scope="col" class="test-que-img">{!! $question->question->mcq_answer !!}</td>
                                                <td scope="col" class="test-que-img">{!! $question->question->solution !!}</td>
                                                <!-- <td scope="col">
                                ...
                                <tbody>
                                    @foreach ($data['unused_questions'] as $key => $question)
                                        <tr>
                                            ...
                                            <td scope="col" class="test-que-img">{!! $question->question !!}</td>
                                            <td scope="col" class="test-que-img">{!! $question->mcq_answer !!}</td>
                                            <td scope="col" class="test-que-img">{!! $question->solution !!}</td>
                                            <td class="text-end">
                                                @if ($data['section']->number_of_questions > $data['total_questions'])
...
@section('javascript')
    ...
    <script>
        $("#submit_question").click(function(){
            window.location = "{{ route('administrator.dashboard_tests_list') }}";
        });
    </script>
@endsection
