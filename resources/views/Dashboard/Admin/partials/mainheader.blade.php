    ...
    <ul class="nav nav-panel icons-panel text-end">
        ...
        <li class="nav-item user-menu dropdown profile-dropdown">
            ...
            <div class="dropdown-content panel-collapse profile-noti dropdown-menu dropdown-menu-end"
                ...
                <div class="profile-box">
                    <img src="{{ auth()->user()->user_details && auth()->user()->user_details['photo_url'] ? '/storage/app/'. auth()->user()->user_details['photo_url'] : asset('super/images/default-avatar.jpg') }}">
                ...
                <ul>
                    ...
                    <li>
                        <a href="#">
                            <i class="bi bi-clock"></i><span> Offers</span>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <i class="bi bi-sliders"></i><span> Information</span>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <i class="bi bi-sliders"></i><span> Activity</span>
                        </a>
                    </li>
