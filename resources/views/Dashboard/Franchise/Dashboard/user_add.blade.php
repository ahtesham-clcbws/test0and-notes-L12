            ...
            <div class="col-md-6 col-12">
                <form class="card" id="reply-hidden" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                            ...
                            <div class="box-input">
                                <div class="input-group flex-nowrap">
                                    ...
                                    <input type="number" min="10" max="10" class="form-control"
                                        placeholder="Mobile number" name="mobile" id="contributor_mobile" oninput="mobileNumberCheck(this, 'register')" required>
                        ...
                        {{-- password --}}
                        <div class="d-flex mb-2" style="display:none !important;">
                            <label class="box-heading text-end">
                                Password
                            </label>
                            <div class="box-input">
