                    ...
                    <div class="d-flex mb-2">
                        ...
                        <div class="box-input">
                            ...
                            <div class="input-group flex-nowrap">
                                ...
                                <input type="text" name="name" class="form-control"
                                    value="{{ $data['user']->email }}" placeholder="Person name" disabled>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="box-input">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control" id="education_type_id" name="education_type_id" onchange="getClassesByEducation(this.value)" required>
                                    ...
                                    <option value="{{ $u->id }}" <?php if ($data['education_type'] == $u->id) {
                                                                        echo 'selected';
                                                                    } ?>>{{ $u->name}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="box-input">
                            ...
                            <div class="input-group flex-nowrap">
                                <span class="input-group-text" id="addon-wrapping"><i
                                        class="bi bi-list"></i></span>
                                <input type="text" name="name" class="form-control"
                                    value="{{ $data['institute_name']->institute_name }}" placeholder="Person name" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex mb-2">
                        ...
                        <div class="box-input">
                            ...
                            <div class="input-group flex-nowrap">
                                <span class="input-group-text" id="addon-wrapping"><i
                                        class="bi bi-list"></i></span>
                                <input type="text" name="name" class="form-control"
                                    value="{{ $data['institute_code']->institute_code }}" placeholder="Person name" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex mb-2">
...
<script>
    ...
    */
    ...
    var student_class = <?php if (isset($data['class'])) {
                            echo $data['class'];
                        } else {
                            echo 0;
                        }  ?>;
