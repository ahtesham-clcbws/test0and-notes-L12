                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="email" id="email" class="form-control"
                                style="border: 1px solid #aaa;" value="<?php echo $user['details']['email']; ?>" placeholder="Enter New Email">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" id="mobile" minlength="10" maxlength="10"
                                class="form-control" value="<?php echo $user['details']['mobile']; ?>" placeholder="Enter New Mobile">
