                ...
                <div class="row">
					...
					<div class="col-md-4 mt-3">
						<div class="form-group">
							...
							<select class="form-select form-select-sm select2" id="category" name="category" required>
								...
								<option value="Comprehensive Study Material" <?php if(isset($UserDetails) && isset($UserDetails->category) && $UserDetails->category == 'Comprehensive Study Material') { echo 'selected'; }?>>Comprehensive Study Material</option>
							</select>
						</div>
                    </div>
					...
					<div class="col-md-12 mt-3">
						<div class="form-group">
                            ...
                            <textarea class="form-control" id="remarks" name="remarks" rows="1"><?php if(isset($UserDetails) && isset($UserDetails->remarks)) { echo $UserDetails->remarks; }?></textarea>
                        </div>
                    </div>
					@endif
						...
						<div class="form-group" style="float:right;">
							@if(isset($UserDetails))
								@if(isset($UserDetails->material_seen) && $UserDetails->material_seen == 1)
									<button type="button" class="btn btn-info" id="pause_material" title="Pause Study Material!">Pause Material</button>
								@else
									<button type="button" class="btn btn-info" id="pause_material" title="Active Study Material!">Active Material</button>
								@endif
							@endif
							<input type="hidden" id="pause_val" name="pause_val" value="<?php if(isset($UserDetails) && isset($UserDetails->material_seen)) { echo $UserDetails->material_seen; }?>">
							@if(isset($UserDetails))
								<button type="button" class="btn btn-warning publish" id="sendback_material" name="sendback_material" title="Send Back Contributor!">Send Back Contributor</button>
