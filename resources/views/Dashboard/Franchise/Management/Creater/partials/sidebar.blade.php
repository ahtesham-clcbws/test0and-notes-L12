        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="test-quizes-collapse">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('franchise.management.creater.dashboard_tests_list') }}">
                                All Test
                            </a>
                            {{-- <a class="nav-link" href="{{ route('franchise.management.creater.dashboard_add_exams') }}">
                                Add Test
                            </a>--}}
                        </li>
                    </ul>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="study-material-collapse">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('franchise.management.creater.material') }}">
                                Add Study Material
                            </a>
                        </li>
                    </ul>
