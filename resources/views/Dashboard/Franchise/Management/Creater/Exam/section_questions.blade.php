...
@section('javascript')
    ...
    <script type="text/javascript" src="{{ asset('js/franchise/management/creater/creatertestsectionquestions.js') }}"></script>
    <script>
        $("#submit_question").click(function(){
            window.location = "{{ route('franchise.management.creater.dashboard_tests_list') }}";
        });
    </script>
@endsection
