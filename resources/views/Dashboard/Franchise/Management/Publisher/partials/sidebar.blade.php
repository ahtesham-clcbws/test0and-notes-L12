<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="position-sticky">
        <div class="user-details text-center py-3">
            ...
            <h5>
                {{ auth()->user()->name }} <br>
                <small>@if(auth()->user()->in_franchise != 0){{auth()->user()->myInstitute->branch_code}}
                @endif
                </small>
            </h5>
        </div>
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="test-quizes-collapse">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('franchise.management.publisher.dashboard_tests_list') }}">
                                All Test
                            </a>
                            {{-- <a class="nav-link" href="{{ route('franchise.management.publisher.dashboard_add_exams') }}">
                                Add Test
                            </a>--}}
                        </li>
                    </ul>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="study-material-collapse">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('franchise.management.publisher.material') }}">
                                Add Study Material
                            </a>
                        </li>
                    </ul>
