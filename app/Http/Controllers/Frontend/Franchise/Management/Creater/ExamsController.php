...
namespace App\Http\Controllers\Frontend\Franchise\Management\Creater;
...
class ExamsController extends Controller
{
    ...
    public function index(Request $req)
    {
            ...
            foreach ($testTableData as $key => $testData) {
                ...
                if ($total_questions == 0) {
                    ...
                    if ($total_questions != $testData->getSection->find($testData['section_id'])->getQuestions()->wherePivot('deleted_at','=',NULL)->count() || $total_questions < $testData->getSection->find($testData['section_id'])->getQuestions()->wherePivot('deleted_at','=',NULL)->count()) {
                        ...
                        elseif($testData['sent_to_publisher'] == 1){
                            ...
                            // $status = '<a><span class="badge bg-primary">Sent to Publisher</span></a>';
                        ...
                        if ($testData['published'] == 1) {
                            $status = '<a><span class="badge bg-success">Published</span></a>';
                ...
                if ($testData['sections']) {
                    ...
                    // foreach ($sectionsX as $keyX => $sectionX) {
                        $sectionUrl = route('franchise.management.creater.dashboard_test_section_question', [$testData['id'], $testData['section_id']]);
        ...
        // dd($this->data);
        return view('Dashboard/Franchise/Management/Creater/Exam/teststable')->with('data', $this->data);
    }
    ...
    public function saveTest(Request $req, $test_id = 0)
    {
        ...
        return view('Dashboard/Franchise/Management/Creater/Exam/savetest')->with('data', $this->data);
    }
    ...
    public function publishTest(Request $req,$test_id)
    {
        ...
        return view('Dashboard/Franchise/Management/Creater/Exam/publish_test')->with('data', $this->data);
    ...
    public function testSections(Request $req, $test_id)
    {
        ...
        $this->data['creators'] = $creators;
        $this->data['pagename'] = 'Test Sections';
        return view('Dashboard/Franchise/Management/Creater/Exam/sections')->with('data', $this->data);
    }
    ...
    public function section_questions(Request $req, $test_id, $section_id)
    {
        ...
        return view('Dashboard/Franchise/Management/Creater/Exam/section_questions')->with('data', $this->data);
    }
