...
class ReviewController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->back()->with('message', 'Thank you! Your review has been submitted and is pending approval.');
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->back()->with('message', 'Your review has been updated and is pending re-approval.');
    }
}
